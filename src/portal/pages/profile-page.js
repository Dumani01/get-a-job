...
import { logout } from "../../core/auth-service.js";
...
export function createProfilePage() {
  ...
  logoutBtn.className = "jc-portal-btn jc-portal-btn--secondary";
  ...
  buttonGroup.append(save, logoutBtn);

  const feedback = document.createElement("p");
  feedback.className = "jc-portal-application-form-message";
  form.append(buttonGroup, feedback);
